      ...
      <IMAGE
        ...
        onDragEnd={(e) => {
          ...
          if (e.target.x() < half + xoffset) {
            image.x =
              half +
              xoffset; /* values are 30 because all legends are of size 60 and offsetted by 60/2 = 30 */
          }
        ...
        offsetX={
          img ? 15 : 0
        } /* these values should be equal to the variable "half", be sure to update them if you play around with the width and height */
        offsetY={img ? 15 : 0}
      />
    );
  };
    ...
    <div>
      ...
      >
        ...
        >
          <Layer>
            {passID.map((passIDs) => (
              <IMAGE x={(innerWidth - width) / 2} y={10} image={srcImg} />
            ))}
          </Layer>
